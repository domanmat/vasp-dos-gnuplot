...
Basic Usage
bash./dosplot-spin.sh <x_min> <x_max> [OPTIONS]
Arguments
...
Batch Processing
bash# Plot DOS for multiple directories
list="dir1 dir2 dir3"
for i in $list; do 
    cd $i
...
Extracts DOS data from vasprun.xml
Identifies atomic types and groups
Processes spin-up and spin-down components separately
Generates gnuplot scripts for visualization
Creates PNG and SVG output files
